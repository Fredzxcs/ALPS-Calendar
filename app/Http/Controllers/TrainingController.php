    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $training = Training::create([
                ...
                'outbound_pickup_date' => $request->outbound_pickup_date,
                ...
                'outbound_trips_json' => $request->input('outbound_trips_json'),
                ...
                'return_trips_json' => $request->input('return_trips_json'),
