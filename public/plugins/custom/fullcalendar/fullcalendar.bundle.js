...
var FullCalendar = function (e) {
    ...
    ***************************************************************************** */
    ...
    function S(e, t, n, r, o, i, a, s, l, u) {
        var p, f, h, v, y, b, D, w = r && r.__k || d, S = w.length;
        for (n.__k = [], p = 0; p < t.length; p++) if (null != (v = n.__k[p] = null == (v = t[p]) || "boolean" == typeof v ? null : "string" == typeof v || "number" == typeof v || "bigint" == typeof v ? g(null, v, null, null, v) : Array.isArray(v) ? g(m, {children: v}, null, null, null) : v.__b > 0 ? g(v.type, v.props, v.key, null, v.__v) : v)) {
            if (v.__ = n, v.__b = n.__b + 1, null === (h = w[p]) || h && v.key == h.key && v.type === h.type) w[p] = void 0; else for (f = 0; f < S; f++) {
    ...
    function $n(e, t, n, r) {
        ...
        for (var c in i) for (var w = 0, S = Fn(i[c], n); w < S.length; w++) {
            D = S[w];
    ...
    var Rr = function () {
        ...
        return e.prototype.setProp = function (e, t) {
            ...
            if (n) {
                var r = this._def, o = this._context, i = o.getCurrentData().eventStore, a = Dn(i, n.instanceId);
                a = br(a, {
                    "": {
                        display: "",
                        startEditable: !0,
    ...
    var Ni = function () {
        ...
        return e.prototype.resetOptions = function (e, t) {
            ...
            var e, t, n, o, i, a, s, l, u, c = this.props, d = this.state, p = this.data,
                ...
                y = f.calendarOptions;
            if (m && m !== y) for (var E in m.timeZone !== y.timeZone && (d.eventSources = v.eventSources = (a = v.eventSources, s = d.dateProfile, l = v, u = s ? s.activeRange : null, pi(a, hi(a, l), u, !0, l)), d.eventStore = v.eventStore = (e = v.eventStore, t = p.dateEnv, n = v.dateEnv, o = e.defs, i = Dt(e.instances, (function (e) {
                var i = o[e.defId];
    ...
    }(Uo), Da = ln({weekday: "long"}), wa = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
    ...
    function Ha(e, t, n, o) {
        return void 0 === n && (n = {}), !(e.eventDrag && !function (e, t, n, o) {
            ...
            var v, g;
            for (var m in u) {
                var y = u[m], E = y.range, b = c[y.defId], D = l[y.defId];
                if (!Aa(b.constraints, E, d, e.businessHours, t)) return !1;
                var w = t.options.eventOverlap, S = "function" == typeof w ? w : null;
                for (var T in f) {
                    var x = f[T];
                    if (qn(E, x.range)) {
                ...
                for (var C = i.eventStore, k = 0, R = b.allows; k < R.length; k++) {
                    var _ = R[k], M = r(r({}, n), {range: y.range, allDay: D.allDay}), I = C.defs[D.defId],
        ...
        function t(t, n) {
            ...
            return o.isRendering = !1, o.isRendered = !1, o.currentClassNames = [], o.customContentRenderId = 0, o.handleAction = function (e) {
                ...
                if (o.isRendering) {
                    o.isRendered = !0;
                    var e = o.currentData;
                    ko(Co(ga, {options: e.calendarOptions, theme: e.theme, emitter: e.emitter}, (function (t, n, i, a) {
                ...
                if (o.isDragging) {
                    ...
                    if (o.clearDrag(), t.emitter.trigger("eventDragStop", {
                        ...
                        if (a === t) {
                            ...
                            var D = p.defs[l.defId], w = p.instances[u.instanceId], S = new _r(a, D, w);
                            a.dispatch({type: "MERGE_EVENTS", eventStore: p});
                            var T = {
                                event: S, relatedEvents: Ir(p, a, w), revert: function () {
    ...
    function fl(e, t, n, r, o, i, a) {
        ...
        for (var w = 0, S = p; w < S.length; w++) {
            var T = S[w], x = e[T.index], C = T.span;
            v[C.start].push({
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            if (c) for (var h = 0, v = t; h < v.length; h++) {
                var g = v[h], m = g.seg, y = m.eventRange.instance.instanceId, E = y + ":" + e,
                    b = g.isVisible && !o[y], D = g.isAbsolute, w = "", S = "";
    ...
    var ql = ln({hour: "numeric", minute: "2-digit", meridiem: !1}), Yl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var a = this, s = this.context.options, l = s.eventMaxStack, u = s.eventShortHeight, c = s.eventOrderStrict,
                ...
                }(e, Gl(e, f, h, d), c, l), b = E.segPlacements, D = E.hiddenGroups;
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            if (null != p && null != f) {
                var h = this.props.cells[p], v = l.positions.tops[f], g = l.positions.getHeight(f), m = (t - v) / g,
                    ...
                    D = o.add(E, b), w = o.add(D, c);
                return {
                    dateProfile: s,
                    dateSpan: r({range: {start: D, end: w}, allDay: !1}, h.extraDateSpan),
                    dayEl: a.els[p],
    ...
    var bu = Bo({themeClasses: {bootstrap: Eu}}), Du = "https://www.googleapis.com/calendar/v3/calendars";
    var wu = Bo({
        eventSourceDefs: [{
            parseMeta: function (e) {
