            ...
            <div class="p-5">
                <form>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            <label for="password" class="fw-bold mb-2">Password Credentials <span class="text-danger">*</span></label>
                            <input type="password" id="password" class="form-control form-control-solid" placeholder="Enter Password">
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="flex-grow-1">
                                <label for="course" class="fw-bold mb-2">Course <span class="text-danger">*</span></label>
                                <select id="course" class="form-select form-select-solid">
                                    <option>Select Course</option>
                                </select>
                            </div>
                            <button type="button" class="btn btn-light-primary btn-icon rounded-3 shadow-sm">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            <label for="time-start" class="fw-bold mb-2">Time Start <span class="text-danger">*</span></label>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="flex-grow-1">
                                <label for="facilitator" class="fw-bold mb-2">Facilitator <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="flex-grow-1">
                                <label for="assistant" class="fw-bold mb-2">Assistant <span class="text-danger">*</span></label>
                                <select id="assistant" class="form-select form-select-solid">
                                    <option>Select Assistant</option>
                                </select>
                            </div>
                            <button type="button"
                            class="btn btn-light-primary btn-icon rounded-3 shadow-sm"
                            style=" padding: 12px;">
