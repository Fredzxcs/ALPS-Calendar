...
<div class="email-container">
    <div class="header">
        Training Reassignment Notification 🔄
    </div>

    <div class="content">
        <p>Hello <strong>{{ $previousFacilitator->name }}</strong>,</p>

        <p>Please be informed that the following training session, which was previously assigned to you, has been reassigned:</p>
        ...
        @if ($newFacilitator)
            <p>This training has been reassigned to <strong>{{ $newFacilitator->name }}</strong>.</p>
        @else
            <p>This training currently does not have an assigned facilitator.</p>
        @endif
