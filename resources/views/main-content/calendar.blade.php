...
<!-- Modal Template -->
<!-- Modal -->
<div class="modal fade" id="kt_modal_view_event" tabindex="-1" aria-labelledby="kt_modal_view_event_label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="kt_modal_view_event_label">Event Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- Content for the modal will go here -->
                <p id="eventDetails">Event information will be displayed here.</p>
            </div>
        </div>
    </div>
</div>
