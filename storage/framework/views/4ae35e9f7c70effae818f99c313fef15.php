    ...
    <div class="email-container">
        ...
        <div class="content">
            <div class="hero-card">
                ...
                <p class="greeting">Hi <?php echo e($previousFacilitator->name); ?>,</p>
                ...
                <?php if($newFacilitator): ?>
                    <div class="detail-block">This training has been reassigned to <strong><?php echo e($newFacilitator->name); ?></strong>.</div>
                <?php else: ?>
...
<?php /**PATH C:\Users\Lagman\Desktop\Codes\ALPs Calendar\ALPS-Calendar\resources\views\emails\reassignment_notification.blade.php ENDPATH**/ ?>