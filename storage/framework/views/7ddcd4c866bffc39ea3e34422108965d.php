                ...
                <form>
                    ...
                    <div id="training-step-1">
                        ...
                        <div class="google-calendar-card">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('google.redirect', ['from' => 'add_training'])); ?>" class="google-calendar-button">
...
<?php echo $__env->make('global.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lagman\Desktop\Codes\ALPs Calendar\ALPS-Calendar\resources\views\add_training\add_training_redesign.blade.php ENDPATH**/ ?>