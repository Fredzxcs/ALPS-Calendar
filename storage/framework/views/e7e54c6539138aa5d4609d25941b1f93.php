                                ...
                                <div class="col-md-12 text-center mt-10">
                                    ...
                                    <div>
                                        ...
                                        <div class="image-input image-input-outline alps-avatar-blank-bg" data-kt-image-input="true">
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px alps-avatar-default-bg" style="background-image: url('<?php echo e(route('access.avatar', $user->id ?? 0)); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;"></div>
...
<script>
    var userId = <?php echo e($user ?? 'null'); ?>; // Pass user ID to JavaScript
</script>
<script src="<?php echo e(asset('js/manage_access.js')); ?>"></script>
<script src="<?php echo e(asset('js/edit_user.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('global.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lagman\Desktop\Codes\ALPs Calendar\ALPS-Calendar\resources\views\access\edit_user.blade.php ENDPATH**/ ?>