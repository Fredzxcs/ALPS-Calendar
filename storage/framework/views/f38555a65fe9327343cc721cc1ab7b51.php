        ...
        <div class="table-responsive alps-table-wrap">
            <table class="table align-middle text-center gy-7 gs-7" id="accounts_table">
                ...
                <tbody>
                    ...
                    <!-- seach entry by id -->
                    <tr id="account-row-<?php echo e($account->id); ?>">

                        <td class="d-flex align-items-center text-start"><?php echo e($account->account_email); ?></td>
                        <td>
                            <span class="password-display alps-password-cell">*****</span>
                            <span class="password-actual d-none alps-password-cell"><?php echo e($account->account_password); ?></span>
                        </td>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <form class="form" action="#" id="modal_add_account_form" novalidate>
                    ...
                    <div id="route-config" data-url="<?php echo e(route('add_account')); ?>"></div>
...
<script src="<?php echo e(asset('js/accounts.js')); ?>"></script>
...
<?php echo $__env->make('global.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lagman\Desktop\Codes\ALPs Calendar\ALPS-Calendar\resources\views\configuration\accounts.blade.php ENDPATH**/ ?>